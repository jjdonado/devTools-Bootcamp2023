function next_pal(num){                                                //Creo la función con el nombre "next_pal"
  while (true) {                                                       //Creo iteración mientras que la condición sea verdadera
      ...
      if (num_invertido == num) {                                      //Comparamos (las variables "num_invertido" y "num")para saber si son iguales el número evaluado en el momento, con el mismo número pero que habíamos invertido en la línea anterio de código.
